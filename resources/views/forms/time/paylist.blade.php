            ...
            <div class="panel-body">
                ...
                <div class="well">
                    ...
                    @if(!Deadline::dateSubLimit(10))
                        ...
                        <div class="col-md-6">
                            <a class="btn btn-primary" style="padding: 25px; min-width: 300px; width: 95%; font-size: 36px;" href="{{ Route('claims.time.pay.last') }}">Create {{ Deadline::dateLimitMonth(10) }} Claim</a>
                        </div>
                        @endif
                    @endif
                    @if(!$timeclaims->contains('month',$d->formatLocalized('%Y-%m-%d')))
                        <div class="col-md-6">
                            <a class="btn btn-success" style="padding: 25px; min-width: 300px; width: 95%; font-size: 36px;" href="{{ Route('claims.time.pay.current') }}">Create {{ Deadline::dateLimitMonth(0) }} Claim</a>
